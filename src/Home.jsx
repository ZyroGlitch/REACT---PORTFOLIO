...
export function Home() {
    return (
        <>
            <div className="grid justify-center items-center sm:grid-cols-2 bg-[#7A1CAC] text-white homepage">
                <div className="flex justify-center items-center">
                    <img src="profile.png" alt="profile" className="object-contain bg-slate-400 w-[400px] h-[400px] shadow-2xl border-2 border-white rounded-full" />
                </div>
